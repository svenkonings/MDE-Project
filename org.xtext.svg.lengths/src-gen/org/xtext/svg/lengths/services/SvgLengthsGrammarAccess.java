 ...
 */
package org.xtext.svg.lengths.services;
...
@Singleton
public class SvgLengthsGrammarAccess extends AbstractGrammarElementFinder {
	
	public class StrokeDashArrayElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.svg.lengths.SvgLengths.StrokeDashArray");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cStrokeDashArrayAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cStrokeDashArrayLengthParserRuleCall_0_0 = (RuleCall)cStrokeDashArrayAssignment_0.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Keyword cCommaKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Assignment cStrokeDashArrayAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cStrokeDashArrayLengthParserRuleCall_1_1_0 = (RuleCall)cStrokeDashArrayAssignment_1_1.eContents().get(0);
		...
		public Assignment getStrokeDashArrayAssignment_0() { return cStrokeDashArrayAssignment_0; }
		
		//Length
		public RuleCall getStrokeDashArrayLengthParserRuleCall_0_0() { return cStrokeDashArrayLengthParserRuleCall_0_0; }
		...
		//strokeDashArray+=Length
		public Assignment getStrokeDashArrayAssignment_1_1() { return cStrokeDashArrayAssignment_1_1; }
		
		//Length
		public RuleCall getStrokeDashArrayLengthParserRuleCall_1_1_0() { return cStrokeDashArrayLengthParserRuleCall_1_1_0; }
	}
	public class LengthElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.svg.lengths.SvgLengths.Length");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NumberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.svg.lengths.SvgLengths.Number");
	...
	public class IntegerElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.svg.lengths.SvgLengths.Integer");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UnitElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.svg.lengths.SvgLengths.Unit");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final StrokeDashArrayElements pStrokeDashArray;
	...
	@Inject
	public SvgLengthsGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pStrokeDashArray = new StrokeDashArrayElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.svg.lengths.SvgLengths".equals(grammar.getName())) {
				return grammar;
			}
	...
	//StrokeDashArray:
	//	strokeDashArray+=Length (","? strokeDashArray+=Length)*;
	public StrokeDashArrayElements getStrokeDashArrayAccess() {
		return pStrokeDashArray;
	}
	
	public ParserRule getStrokeDashArrayRule() {
		return getStrokeDashArrayAccess().getRule();
	}
