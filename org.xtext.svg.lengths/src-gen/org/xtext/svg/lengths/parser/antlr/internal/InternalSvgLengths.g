...
// Entry rule entryRuleStrokeDashArray
entryRuleStrokeDashArray returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStrokeDashArrayRule()); }
	iv_ruleStrokeDashArray=ruleStrokeDashArray
	{ $current=$iv_ruleStrokeDashArray.current; }
	EOF;

// Rule StrokeDashArray
ruleStrokeDashArray returns [EObject current=null]
@init {
	enterRule();
}
@after {
