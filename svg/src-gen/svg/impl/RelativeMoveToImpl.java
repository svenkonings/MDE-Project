...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relative Move To</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link svg.impl.RelativeMoveToImpl#getDx <em>Dx</em>}</li>
 *   <li>{@link svg.impl.RelativeMoveToImpl#getDy <em>Dy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelativeMoveToImpl extends PathValueImpl implements RelativeMoveTo {
	/**
	...
	protected EClass eStaticClass() {
		return SvgPackage.Literals.RELATIVE_MOVE_TO;
	}
	...
	public void setDx(BigDecimal newDx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_MOVE_TO__DX, oldDx, dx));
	}
	...
	public void setDy(BigDecimal newDy) {
		...
		dy = newDy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_MOVE_TO__DY, oldDy, dy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SvgPackage.RELATIVE_MOVE_TO__DX:
			return getDx();
		case SvgPackage.RELATIVE_MOVE_TO__DY:
			return getDy();
		}
