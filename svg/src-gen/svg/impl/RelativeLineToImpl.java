...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relative Line To</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link svg.impl.RelativeLineToImpl#getDx <em>Dx</em>}</li>
 *   <li>{@link svg.impl.RelativeLineToImpl#getDy <em>Dy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelativeLineToImpl extends PathValueImpl implements RelativeLineTo {
	/**
	...
	protected EClass eStaticClass() {
		return SvgPackage.Literals.RELATIVE_LINE_TO;
	}
	...
	public void setDx(BigDecimal newDx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_LINE_TO__DX, oldDx, dx));
	}
	...
	public void setDy(BigDecimal newDy) {
		...
		dy = newDy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_LINE_TO__DY, oldDy, dy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SvgPackage.RELATIVE_LINE_TO__DX:
			return getDx();
		case SvgPackage.RELATIVE_LINE_TO__DY:
			return getDy();
		}
