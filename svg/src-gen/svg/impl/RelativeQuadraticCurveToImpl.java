...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relative Quadratic Curve To</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link svg.impl.RelativeQuadraticCurveToImpl#getDcx <em>Dcx</em>}</li>
 *   <li>{@link svg.impl.RelativeQuadraticCurveToImpl#getDcy <em>Dcy</em>}</li>
 *   <li>{@link svg.impl.RelativeQuadraticCurveToImpl#getDx <em>Dx</em>}</li>
 *   <li>{@link svg.impl.RelativeQuadraticCurveToImpl#getDy <em>Dy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelativeQuadraticCurveToImpl extends PathValueImpl implements RelativeQuadraticCurveTo {
	/**
	 ...
	 * @generated
	 */
	protected RelativeQuadraticCurveToImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SvgPackage.Literals.RELATIVE_QUADRATIC_CURVE_TO;
	}
	...
	public void setDcx(BigDecimal newDcx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DCX, oldDcx,
					dcx));
	}
	...
	public void setDcy(BigDecimal newDcy) {
		...
		dcy = newDcy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DCY, oldDcy,
					dcy));
	}
	...
	public void setDx(BigDecimal newDx) {
		...
		dx = newDx;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DX, oldDx,
					dx));
	}
	...
	public void setDy(BigDecimal newDy) {
		...
		dy = newDy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DY, oldDy,
					dy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DCX:
			return getDcx();
		case SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DCY:
			return getDcy();
		case SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DX:
			return getDx();
		case SvgPackage.RELATIVE_QUADRATIC_CURVE_TO__DY:
			return getDy();
		}
